...
public class ArrayListEx {
	public static void main(String[] args) {
		...
		alist1.add(null);
		System.out.println("is Empty?: "+alist1.isEmpty());
		System.out.println("get Elemt: "+alist1.get(2));
		System.out.println("index of Elemt: "+alist1.indexOf(10));
		System.out.println("last index of Elemt: "+alist1.lastIndexOf(10));
